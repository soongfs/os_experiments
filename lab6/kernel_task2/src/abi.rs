...
pub const SYS_STAT_DIAG: usize = 10;
...
pub const FS_DEVICE_ID: u64 = 0x4c36_0002;
...
#[repr(C)]
#[derive(Clone, Copy)]
pub struct StatDiagnostics {
    pub stat_calls: u64,
    pub successful_lookups: u64,
    pub failed_lookups: u64,
    pub successful_copyouts: u64,
    pub last_inode_number: u64,
    pub last_kind: u64,
    pub last_size_bytes: u64,
    pub last_error: i64,
}

impl StatDiagnostics {
    pub const fn empty() -> Self {
        Self {
            stat_calls: 0,
            successful_lookups: 0,
            failed_lookups: 0,
            successful_copyouts: 0,
            last_inode_number: 0,
            last_kind: 0,
            last_size_bytes: 0,
            last_error: 0,
