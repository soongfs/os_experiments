...
use crate::abi::{
    FsDiagnostics, FsStat, EEXIST, EFBIG, EFAULT, EINVAL, EISDIR, ENAMETOOLONG, ENOENT, ENOSPC,
    ENOTDIR, ENOTEMPTY, ENOSYS, SYS_CREATE_DIR, SYS_CREATE_FILE, SYS_FS_DIAG, SYS_LIST_DIR,
...
pub fn fs_diag(diag: &mut FsDiagnostics) -> isize {
    invoke_syscall5(SYS_FS_DIAG, diag as *mut FsDiagnostics as usize, 0, 0, 0, 0)
}
