...
use crate::abi::{
    DirDiagnostics, FsStat, EEXIST, EFBIG, EFAULT, EINVAL, EISDIR, ENAMETOOLONG, ENOENT,
    ENOSPC, ENOTDIR, ENOTEMPTY, ENOSYS, SYS_CREATE_DIR, SYS_CREATE_FILE, SYS_DIR_DIAG,
    SYS_LIST_DIR, SYS_READ_AT, SYS_REMOVE, SYS_SHUTDOWN, SYS_STAT, SYS_TIME_US, SYS_WRITE,
    SYS_WRITE_AT,
};
...
pub fn dir_diag(diag: &mut DirDiagnostics) -> isize {
    invoke_syscall5(
        SYS_DIR_DIAG,
        diag as *mut DirDiagnostics as usize,
        0,
        0,
        0,
        0,
